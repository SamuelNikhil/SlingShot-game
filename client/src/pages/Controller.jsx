...
export default function Controller() {
  ...
  const requestGyroPermission = async () => {
    ...
    if (gyroWorking) {
      ...
      SoundManager.playAim(); // Play sound when enabling gyro
    } else {
  ...
  const handleStart = (e) => {
    ...
    SoundManager.playAim(); // Play sound when starting to aim
  };
    ...
    return (
      ...
      >
        <div style={{ maxWidth: "300px" }}>
          ...
          >
            Allows gyroscope aiming. Tap to enable.
          </p>
          <button
